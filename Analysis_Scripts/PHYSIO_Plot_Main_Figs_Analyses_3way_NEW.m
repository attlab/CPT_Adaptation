...
% do baseline correction? (MUST BE 0 FOR THIS ANALYSIS)
...
for iMeasure=1:8
    ...
    else % compute ANOVA results now [comment - this won't work here]
...
%         end
    ...
    for theseLines=1:7
        ...
        text([20,20],[YlinePos,YlinePos],textLabel,'fontsize',15);
...
%         end
    ...
    if plotBlCorrectedPhysio
        ...
        export_fig([destDir '/' 'Physio_wStats_Bln_Within_' thisTitle1 '_anv_3way_all_effects' '.eps'],h,'-eps','-transparent')
        ...
        export_fig([destDir '/' 'Physio_wStats_Raw_Within_' thisTitle1 '_anv_3way_all_effects' '.eps'],h,'-eps','-transparent')
    end
