...
load([sourceDir '/' 'PHYSIO_MASTER_FIXED_301122.mat' ])
...
for iMeasure=1:8
    ...
    allPhysio=[];
    if plotBlCorrectedPhysio
        if      iMeasure==1; allPhysio = all_CO; thisTitle1 = 'CO'; thisEBXPosStart=-5; thisEBYPosStart = 0; % 73
        elseif  iMeasure==2; allPhysio = all_HR; thisTitle1 = 'HR'; thisEBXPosStart=-5; thisEBYPosStart = 0; % 73
        elseif  iMeasure==3; allPhysio = all_LVET; thisTitle1  = 'LVET'; thisEBXPosStart=-5; thisEBYPosStart = -.5; % 73
        elseif  iMeasure==4; allPhysio = all_PEP; thisTitle1= 'PEP'; thisEBXPosStart=-5; thisEBYPosStart = 0; % 162
        elseif  iMeasure==5; allPhysio = all_SV; thisTitle1 = 'SV'; thisEBXPosStart=-5; thisEBYPosStart = -.7; % 162
        elseif  iMeasure==6; allPhysio = all_TPR; thisTitle1 = 'TPR'; thisEBXPosStart=-5; thisEBYPosStart = -.7; %125
        elseif  iMeasure==7; allPhysio = all_BP; thisTitle1 = 'BP'; thisEBXPosStart=-5; thisEBYPosStart = 0; % 73
        elseif  iMeasure==8; allPhysio = all_HF; thisTitle1 = 'HF'; thisEBXPosStart=-5; thisEBYPosStart = 0; % 125
        end
        thisYlim = [-.3,1];
...
%         %TOM ADD GRAY RECT [BEHND LINES]
%         grayRectColor = [0.6,0.6,0.6];
%         if plotBlCorrectedPhysio
...
%         set(gca,'Visible','off','XLim',theseXlims,'yLim',[1,3])
    ...
    if plotType==1
        if plotBlCorrectedPhysio
            ...
            %print([destDir '/' 'Physio_wStats_Bln_Within_' thisTitle1 '_anv' '.eps'],'-depsc','-opengl')
            ...
            %print([destDir '/' 'Physio_wStats_Raw_Within_' thisTitle1 '_anv' '.eps'],'-depsc','-opengl')
