...
% %% set up function
% if runInParallel
%     thisFunction = 'Time_Freq_Analysis_FFT.m';
%     s = parcluster;
...
for iSub =1:length(subjects)
    ...
    if runInParallel
        %job.createTask(@Time_Freq_Analysis_FFT,0,{sjNum})
        createTask(job,@Time_Freq_Analysis_FFT,0,{sjNum})
    else
        Time_Freq_Analysis_FFT(sjNum)
    end
end
