%{
Time_Freq_Analysis_BAND_Compile
Author: Tom Bullock
Date: 12.23.19

Compile all the bandpassed data.
...
if analysisType==2
    sourceDir = '/home/bullock/BOSS/CPT_Adaptation/Time_Freq_Results_Band';
...
elseif analysisType==3
    ...
    sourceDir = '/home/bullock/BOSS/CPT_Adaptation/Time_Freq_Results_Band_1-30Hz_ICA_Brain_80';
    destDir = '/home/bullock/BOSS/CPT_Adaptation/Data_Compiled';
end
...
if analysisType==2
    save([destDir '/' 'Time_Freq_Bandpassed_Data__Band_ICA_OCC.mat'],'alpha_all','delta_all','theta_all','beta_all','chanlocs')
elseif analysisType==3
    save([destDir '/' 'Time_Freq_Bandpassed_Data_Band_ICA_Brain80.mat'],'alpha_all','delta_all','theta_all','beta_all','chanlocs')
end
...
for thisFreq=1:4
    figure;
    if      thisFreq==1; theseData = delta_all; thisYlim=[-10,10]; thisTitle = 'Delta';
    elseif  thisFreq==2; theseData = theta_all; thisYlim=[-10,10]; thisTitle = 'Theta';
    elseif  thisFreq==3; theseData = alpha_all; thisYlim=[-10,10]; thisTitle = 'Alpha';
    elseif  thisFreq==4; theseData = beta_all; thisYlim=[-10,10]; thisTitle = 'Beta';
    end
